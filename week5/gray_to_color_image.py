...
img = cv2.imread('imgs/pexels-photo-3422137.jpeg')
...
print("w is : {}, h is : {}".format(w/2, h/2))
img_input = cv2.resize(img_input, dsize=(w//2, h//2))
output_bgr = cv2.resize(output_bgr, dsize=(w//2, h//2))
